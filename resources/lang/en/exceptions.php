...
return [
	...
	"packages" => [
	"already_exists" => "That PackageList already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this PackageList. Please try again.",
	"delete_error" => "There was a problem deleting this PackageList. Please try again.",
	"not_found" => "That PackageList does not exist.",
	"update_error" => "There was a problem updating this PackageList. Please try again.",
	],
	"tests" => [
	...
	"abcs" => [
	"already_exists" => "That Abc already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Abc. Please try again.",
	"delete_error" => "There was a problem deleting this Abc. Please try again.",
	"not_found" => "That Abc does not exist.",
	"update_error" => "There was a problem updating this Abc. Please try again.",
	],
	"abcds" => [
	"already_exists" => "That Abcd already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Abcd. Please try again.",
	"delete_error" => "There was a problem deleting this Abcd. Please try again.",
	"not_found" => "That Abcd does not exist.",
	"update_error" => "There was a problem updating this Abcd. Please try again.",
	],
	"tickets" => [
	"already_exists" => "That TicketList already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this TicketList. Please try again.",
	"delete_error" => "There was a problem deleting this TicketList. Please try again.",
	"not_found" => "That TicketList does not exist.",
	"update_error" => "There was a problem updating this TicketList. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://laraveladmin2/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
