<!--Action Button-->
@if( Active::checkUriPattern( 'admin/abcds' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.abcds.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.abcds.all' ) }}
            </a>
        </li>
        @permission( 'create-abcd' )
            <li>
                <a href="{{ route( 'admin.abcds.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.abcds.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
