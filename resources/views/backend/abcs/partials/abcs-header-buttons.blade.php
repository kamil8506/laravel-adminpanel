<!--Action Button-->
@if( Active::checkUriPattern( 'admin/abcs' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.abcs.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.abcs.all' ) }}
            </a>
        </li>
        @permission( 'create-abc' )
            <li>
                <a href="{{ route( 'admin.abcs.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.abcs.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
