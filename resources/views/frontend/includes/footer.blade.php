		    ...
		    <div class="footer-container">
		                ...
		                <div class="row">
		                    <div class="col-md-6 col-lg-3">
		                        ...
		                        <div class="single-footer-widget mb-30">
                                    <a class="footer-logo" href="index.html"><img src="{{route('frontend.index')}}/img/logo/logo-footer.png" alt=""></a>
		        ...
		        <div class="footer-bottom-area pt-20 pb-20">
		            <div class="container text-center">
		               <p><span>&copy;</span> Copyright, 2018 All right reserved by <a href="#">Kachari</a></p>
		            </div>
		        </div>
